...
export default function PerekamanMemoriPK(props) {
  ...
  return (
    <div hidden={props.hidden}>
      <h2>Perekaman Memori Peninjauan Kembali</h2>
      <Form form={form} onFinish={submitData} {...layout}>
        ...
        <Form.Item {...tailLayoutLarge} label="No /Tanggal MPK">
          <Input.Group compact>
        ...
        <Form.Item name="hasilAnalisa" label="Hasil Analisa dan Kesimpulan MPK">
          <TextArea />
        </Form.Item>
